  ...
  return (
    <div>
      ...
      >
        ...
        <button
          type="submit"
          className=" mx-auto mt-2 flex h-10 items-center  justify-center rounded-lg bg-tangerine px-4 font-semibold text-white text-lg focus:ring-4 hover:bg-[#ff6229] transition-all delay-300 shadow-md"
        >
          Submit
        </button>
      </form>
